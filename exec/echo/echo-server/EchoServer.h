...
private:
	...
	void OnRecv(std::shared_ptr<network::Client> client, std::span<const char> data) override;
	void OnSend(std::shared_ptr<network::Client> client, size_t bytesTransferred) override;
