...
namespace highp::net {
    ...
    struct NetworkCfg {
        ...
        static NetworkCfg FromFile(const std::filesystem::path& path) {
            auto cfg = config::Config::FromFile(path);
            if (!cfg.has_value()) {
        ...
        static NetworkCfg FromCfg(const config::Config& cfg) {
            return NetworkCfg{
                .server = {
                ...
                .thread = {
                    .maxWorkerThreadMultiplier = cfg.Int("thread.max_worker_thread_multiplier",
                                                         Thread::Defaults::maxWorkerThreadMultiplier,
                                                         "THREAD_MAX_WORKER_THREAD_MULTIPLIER"),
                    .maxAcceptorThreadCount = cfg.Int("thread.max_acceptor_thread_count",
                                                      Thread::Defaults::maxAcceptorThreadCount,
                                                      "THREAD_MAX_ACCEPTOR_THREAD_COUNT"),
                    .desirableIocpThreadCount = cfg.Int("thread.desirable_iocp_thread_count",
                                                        Thread::Defaults::desirableIocpThreadCount,
                                                        "THREAD_DESIRABLE_IOCP_THREAD_COUNT"),
                },
            };
        }
